(ns om-next-kanban.app
  (:require [om.next :as om :refer-macros [defui]]
            ...
            [om-next-kanban.components.card :refer [Assignee Card]]
            [om-next-kanban.components.card-dialog :refer [CardDialog card-dialog]]
            [om-next-kanban.components.lane :refer [Lane]]
            [om-next-kanban.components.about :refer [about]]))
