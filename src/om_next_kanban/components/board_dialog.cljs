(ns om-next-kanban.components.board-dialog
  (:require [goog.object :as gobj]
            [om.next :as om :refer-macros [defui]]
            [om.dom :as dom]
            [om-next-kanban.components.card :refer [Assignee assignee]]
            [om-next-kanban.components.sortable-list :refer [sortable-list]]))
